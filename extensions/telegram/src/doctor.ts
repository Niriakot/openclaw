...
function collectTelegramSelectedQuoteToolProgressWarnings(params: {
  ...
  return [
    ...
    '- Set replyToMode: "off" when tool-progress preview matters more than native quote replies, or set streaming.progress.toolProgress: false to keep quote replies and silence this warning.',
  ];
}
